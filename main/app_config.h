...
#define VOICE_START_RMS_THRESHOLD 55
#define VOICE_START_RMS_MARGIN 35
#define VOICE_START_CONFIRM_CHUNKS 2
#define SILENCE_RMS_THRESHOLD 35
#define SILENCE_RMS_MARGIN 10
...
#define AUDIO_READ_BUFFER_BYTES 1024
